...
public class ChatRoomController {
	...
	public String chatRoomList(@RequestParam(defaultValue="1") int nowPage, Model model) {
		...
		List<ChatRoom> chatRoomList = chatRoomService.chatRoomList(rowBounds);
		model.addAttribute("chatRoomList", chatRoomList);
		System.out.println("list" + "+"+ "=" + chatRoomList);
